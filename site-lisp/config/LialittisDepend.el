...
(require 'apt-sources-list)                  ;Apt源编辑
;; (require 'rect)                         ;矩形编辑
;; (require 'rect-mark)                    ;矩形操作
(require 'term+)                         ;终端模拟器  ;; melp @tianchi
...
(require 'auto-complete-c-headers)            ;集成 auto-complete c headers @tianchi
(require 'auto-complete-clang)            ;集成 auto-complete clang @tianchi
